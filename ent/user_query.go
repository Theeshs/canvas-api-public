...
func (_q *UserQuery) QueryEducations() *EducationQuery {
...
func (_q *UserQuery) QueryExperiences() *ExperienceQuery {
...
func (_q *UserQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *UserQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *UserQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *UserQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *UserQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *UserQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserQuery) WithEducations(opts ...func(*EducationQuery)) *UserQuery {
	query := (&EducationClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithExperiences(opts ...func(*ExperienceQuery)) *UserQuery {
	query := (&ExperienceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) loadEducations(ctx context.Context, query *EducationQuery, nodes []*User, init func(*User), assign func(*User, *Education)) error {
...
func (_q *UserQuery) loadExperiences(ctx context.Context, query *ExperienceQuery, nodes []*User, init func(*User), assign func(*User, *Experience)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(experience.FieldUserID)
	}
