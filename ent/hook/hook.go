...
// The TechSctackFunc type is an adapter to allow the use of ordinary
// function as TechSctack mutator.
type TechSctackFunc func(context.Context, *ent.TechSctackMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TechSctackFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TechSctackMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TechSctackMutation", m)
}
...
// The UserSkillAssociationFunc type is an adapter to allow the use of ordinary
// function as UserSkillAssociation mutator.
type UserSkillAssociationFunc func(context.Context, *ent.UserSkillAssociationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserSkillAssociationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserSkillAssociationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserSkillAssociationMutation", m)
}
