...
func ExperienceID(v uint) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(sql.FieldEQ(FieldExperienceID, v))
}
...
func ExperienceIDEQ(v uint) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(sql.FieldEQ(FieldExperienceID, v))
}

// ExperienceIDNEQ applies the NEQ predicate on the "experience_id" field.
func ExperienceIDNEQ(v uint) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(sql.FieldNEQ(FieldExperienceID, v))
}

// ExperienceIDIn applies the In predicate on the "experience_id" field.
func ExperienceIDIn(vs ...uint) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(sql.FieldIn(FieldExperienceID, vs...))
}

// ExperienceIDNotIn applies the NotIn predicate on the "experience_id" field.
func ExperienceIDNotIn(vs ...uint) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(sql.FieldNotIn(FieldExperienceID, vs...))
}
...
func HasExperience() predicate.UserSkillAssociation {
...
func HasExperienceWith(preds ...predicate.Experience) predicate.UserSkillAssociation {
	return predicate.UserSkillAssociation(func(s *sql.Selector) {
