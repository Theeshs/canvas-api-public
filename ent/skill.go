...
func (e SkillEdges) UserSkillAssociationOrErr() ([]*UserSkillAssociation, error) {
	if e.loadedTypes[0] {
...
// QueryUserSkillAssociation queries the "user_skill_association" edge of the Skill entity.
func (_m *Skill) QueryUserSkillAssociation() *UserSkillAssociationQuery {
