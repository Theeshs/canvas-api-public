...
// InstituteName applies equality check predicate on the "institute_name" field. It's identical to InstituteNameEQ.
func InstituteName(v string) predicate.Education {
	return predicate.Education(sql.FieldEQ(FieldInstituteName, v))
}
...
// CurrentlyStudying applies equality check predicate on the "currently_studying" field. It's identical to CurrentlyStudyingEQ.
func CurrentlyStudying(v bool) predicate.Education {
	return predicate.Education(sql.FieldEQ(FieldCurrentlyStudying, v))
}
...
// InstituteNameEQ applies the EQ predicate on the "institute_name" field.
func InstituteNameEQ(v string) predicate.Education {
	return predicate.Education(sql.FieldEQ(FieldInstituteName, v))
}

// InstituteNameNEQ applies the NEQ predicate on the "institute_name" field.
func InstituteNameNEQ(v string) predicate.Education {
	return predicate.Education(sql.FieldNEQ(FieldInstituteName, v))
}

// InstituteNameIn applies the In predicate on the "institute_name" field.
func InstituteNameIn(vs ...string) predicate.Education {
	return predicate.Education(sql.FieldIn(FieldInstituteName, vs...))
}

// InstituteNameNotIn applies the NotIn predicate on the "institute_name" field.
func InstituteNameNotIn(vs ...string) predicate.Education {
	return predicate.Education(sql.FieldNotIn(FieldInstituteName, vs...))
}

// InstituteNameGT applies the GT predicate on the "institute_name" field.
func InstituteNameGT(v string) predicate.Education {
	return predicate.Education(sql.FieldGT(FieldInstituteName, v))
}

// InstituteNameGTE applies the GTE predicate on the "institute_name" field.
func InstituteNameGTE(v string) predicate.Education {
	return predicate.Education(sql.FieldGTE(FieldInstituteName, v))
}

// InstituteNameLT applies the LT predicate on the "institute_name" field.
func InstituteNameLT(v string) predicate.Education {
	return predicate.Education(sql.FieldLT(FieldInstituteName, v))
}

// InstituteNameLTE applies the LTE predicate on the "institute_name" field.
func InstituteNameLTE(v string) predicate.Education {
	return predicate.Education(sql.FieldLTE(FieldInstituteName, v))
}

// InstituteNameContains applies the Contains predicate on the "institute_name" field.
func InstituteNameContains(v string) predicate.Education {
	return predicate.Education(sql.FieldContains(FieldInstituteName, v))
}

// InstituteNameHasPrefix applies the HasPrefix predicate on the "institute_name" field.
func InstituteNameHasPrefix(v string) predicate.Education {
	return predicate.Education(sql.FieldHasPrefix(FieldInstituteName, v))
}

// InstituteNameHasSuffix applies the HasSuffix predicate on the "institute_name" field.
func InstituteNameHasSuffix(v string) predicate.Education {
	return predicate.Education(sql.FieldHasSuffix(FieldInstituteName, v))
}

// InstituteNameEqualFold applies the EqualFold predicate on the "institute_name" field.
func InstituteNameEqualFold(v string) predicate.Education {
	return predicate.Education(sql.FieldEqualFold(FieldInstituteName, v))
}

// InstituteNameContainsFold applies the ContainsFold predicate on the "institute_name" field.
func InstituteNameContainsFold(v string) predicate.Education {
	return predicate.Education(sql.FieldContainsFold(FieldInstituteName, v))
}
...
// CurrentlyStudyingEQ applies the EQ predicate on the "currently_studying" field.
func CurrentlyStudyingEQ(v bool) predicate.Education {
	return predicate.Education(sql.FieldEQ(FieldCurrentlyStudying, v))
}

// CurrentlyStudyingNEQ applies the NEQ predicate on the "currently_studying" field.
func CurrentlyStudyingNEQ(v bool) predicate.Education {
	return predicate.Education(sql.FieldNEQ(FieldCurrentlyStudying, v))
}

// CurrentlyStudyingIsNil applies the IsNil predicate on the "currently_studying" field.
func CurrentlyStudyingIsNil() predicate.Education {
	return predicate.Education(sql.FieldIsNull(FieldCurrentlyStudying))
}

// CurrentlyStudyingNotNil applies the NotNil predicate on the "currently_studying" field.
func CurrentlyStudyingNotNil() predicate.Education {
	return predicate.Education(sql.FieldNotNull(FieldCurrentlyStudying))
}
