...
func (_q *SkillQuery) QueryUserSkillAssociation() *UserSkillAssociationQuery {
...
func (_q *SkillQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *SkillQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *SkillQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *SkillQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *SkillQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *SkillQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SkillQuery) WithUserSkillAssociation(opts ...func(*UserSkillAssociationQuery)) *SkillQuery {
	query := (&UserSkillAssociationClient{config: _q.config}).Query()
...
func (_q *SkillQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Skill, error) {
	...
	if query := _q.withUserSkillAssociation; query != nil {
		if err := _q.loadUserSkillAssociation(ctx, query, nodes,
			func(n *Skill) { n.Edges.UserSkillAssociation = []*UserSkillAssociation{} },
...
func (_q *SkillQuery) loadUserSkillAssociation(ctx context.Context, query *UserSkillAssociationQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *UserSkillAssociation)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userskillassociation.FieldSkillID)
	}
	query.Where(predicate.UserSkillAssociation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(skill.UserSkillAssociationColumn), fks...))
	}))
...
func (_q *SkillQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(skill.Table, skill.Columns, sqlgraph.NewFieldSpec(skill.FieldID, field.TypeUint))
	_spec.From = _q.sql
