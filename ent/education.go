...
type Education struct {
	...
	// InstituteName holds the value of the "institute_name" field.
	...
	// CurrentlyStudying holds the value of the "currently_studying" field.
...
func (*Education) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case education.FieldInstituteName, education.FieldModeOfStudy, education.FieldDegreeType, education.FieldAreaOfStudy, education.FieldDescription:
	...
	for i := range columns {
		...
		case education.FieldInstituteName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field institute_name", values[i])
			} else if value.Valid {
				_m.InstituteName = value.String
			}
...
func (_m *Education) QueryUser() *UserQuery {
	return NewEducationClient(_m.config).QueryUser(_m)
}
...
func (_m *Education) String() string {
	...
	builder.WriteString("institute_name=")
	builder.WriteString(_m.InstituteName)
	builder.WriteString(", ")
	...
	builder.WriteString(_m.ModeOfStudy)
	builder.WriteString(", ")
	builder.WriteString("degree_type=")
	builder.WriteString(_m.DegreeType)
	builder.WriteString(", ")
	builder.WriteString("area_of_study=")
	builder.WriteString(_m.AreaOfStudy)
	builder.WriteString(", ")
	builder.WriteString("currently_studying=")
	builder.WriteString(fmt.Sprintf("%v", _m.CurrentlyStudying))
	builder.WriteString(", ")
